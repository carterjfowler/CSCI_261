...
int main() {
    ...
    const double CIRCLE_PI = 3.14159;   //pi constant variable for circle  /*constants must be CAPITALIZED_WITH_UNDERSCORES!!*/
    ...
    cout << "Box volume:";                                                  //These print the calculated volume and area
    cout <<  fixed << setprecision(3) << setw(16) << volume << endl;        //formats the numbers so that there are only 3 decimals and the two numbers line up on the right side
    cout << "Circle area:"; 
    cout << fixed << setprecision(3) << setw(15) << circleArea << endl;
